...
class CORE_EXPORT QgsNetworkAccessManager : public QNetworkAccessManager
{
  ...
  public:
     ...
     * \since QGIS 3.6
     */
    static QgsNetworkReplyContent blockingGet( QNetworkRequest &request, const QString &authCfg = QString(), bool forceRefresh = false, bool logError = true, QgsFeedback *feedback = nullptr );
     ...
     * \since QGIS 3.6
     */
    static QgsNetworkReplyContent blockingPost( QNetworkRequest &request, const QByteArray &data, const QString &authCfg = QString(), bool forceRefresh = false, bool logError = true, QgsFeedback *feedback = nullptr);
